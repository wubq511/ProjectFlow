...
T44/T45 之后的 2026-07-14 UX/Runtime 打磨完成设置入口迁移、AgentSidebar 精简、设置页重构、斜杠命令高亮和 Composer steering。2026-07-16 演示种子数据 V2 完成完整生命周期轨迹。2026-07-17 T46 Slice 0 合并到 `main`；2026-07-19 Issue #95 的 Slice 1 hard-domain foundation 合并到 `main`；2026-07-20 Issue #96 的多轮、Skill、Runtime、可靠性、paired comparison 与 exit gate 合并到 `main` 并关闭。详见 `docs/demo-script.md`、Slice 0/1 handoff。

> 当前阶段：Issue #96 已合并并关闭，Slice 1 完成。下一 ticket 是 Issue #97（evidence-graded RCA 与 Repair Packets）；不得在 #97 中提前实现 Dashboard、语义 Judge 或自动修改/合并 ProjectFlow。付费模型在价格和调用前上限冻结前继续 fail-closed；Proposal-Confirm、会话隐私、业务事实边界和 frozen standards 不变。
