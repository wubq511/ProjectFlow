...
- backend API task (due 07-12) is 3 days overdue when detected on 07-14
...
- 后端 API 原定 due 07-12，前端 Shell due 07-12，Agent 核心 due 07-15

### Trigger (07-14 签到)
1. 小张在 check-in 中报告 blocker："SQLite 外键约束报错，还在排查"
2. 小张可用时间从 8 小时/周降至 6 小时/周
3. 后端 API 任务已逾期 3 天（due 07-12 → detection 07-14）
