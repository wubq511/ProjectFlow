...
class AgentRunV2(SQLModel, table=True):
    ...
    resolved_model_provider: str = Field(default="")
    resolved_model_name: str = Field(default="")
    model_fallback_reason: str | None = Field(default=None)
...
class AgentRunStatePatch(SQLModel):
    ...
    resolved_model_provider: str | None = Field(default=None)
    resolved_model_name: str | None = Field(default=None)
    model_fallback_reason: str | None = Field(default=None)
    pending_tool_call_id: str | None = Field(default=None)
    pending_tool_name: str | None = Field(default=None)
    pending_tool_version: int | None = Field(default=None)
